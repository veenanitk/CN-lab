...
main (int argc, char *argv[])
{
  ...
  std::string deviceName ("enp2s0"); // your machine name(use ifconfig)
  std::string remote ("74.125.24.103"); // google.com
  ...
  // "1.2.3.4" string.
  //
  Ipv4Address gateway ("10.53.128.1 "); //use netstat -rn
